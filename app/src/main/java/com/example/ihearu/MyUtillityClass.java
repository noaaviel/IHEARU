...
public class MyUtillityClass {
    ...
    private void sendSMS(String mapUrl,  String[] phNo) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(mContext, 20, new Intent(com.example.ihearu.MyReceiver.ACTION_SMS_SENT),
                PendingIntent.FLAG_UPDATE_CURRENT);

        PendingIntent deliveryIntent = PendingIntent.getBroadcast(mContext, 73, new Intent(com.example.ihearu.MyReceiver.ACTION_SMS_DELIVERED),
                PendingIntent.FLAG_UPDATE_CURRENT);
